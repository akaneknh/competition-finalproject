...
<body>
  ...
  <form method="POST" action="#" enctype="multipart/form-data">
    ...
    <?php
         echo '<input type="password" name="fname" value="'.$user['pass'].'" required>';
       ?>
...
<?php 
  if($_SERVER['REQUEST_METHOD']=='POST'){// check order and edit
    $editCon = "UPDATE user_tb SET firstName='".$_POST['fname']."', lastName='".$_POST['lname']."', email='".$_POST['email']."', pass ='".$_POST['pass']."', dob='".$_POST['dob']."', phone='".$_POST['phone']."', addr='".$_POST['addr']."', title='".$_POST['title']."' WHERE user_id=".$_POST['user_id'];
